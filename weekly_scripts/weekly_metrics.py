...
if __name__ == '__main__':
    year = 2025
    # run the charts
    week_max = 8  # set a max week (e.g. use 14 to only see regular season) **max 17**
    current_week = 8  # set current week to use on charts that are specific to a single week **max 17**
